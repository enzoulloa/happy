...
const Statistics = () => {
  ...
  return (
    <section className=' mx-auto w-full max-w-7xl overflow-hidden bg-[#e01d1d] py-10 px-4 text-center lg:py-24 xl:max-w-none'>
      <div ref={ref1} className=' grid auto-cols-fr grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto transition duration-300 ease-in-out opacity-0'>
